...
{
    public class ProizvodiAdminService : IProizvodiAdminService
    {
        private readonly IMapper _mapper;
        private readonly IGenericRepository<Proizvod> _repo;
        private readonly ILogger<ProizvodiAdminService> _logger;
        private readonly IProizvodiRepository _proizvodiRepo;

        public ProizvodiAdminService(IGenericRepository<Proizvod> repo, IMapper mapper, ILogger<ProizvodiAdminService> logger, IProizvodiRepository proizvodiRepo)
        {
